...
<!-- UsageSnippet language="go" operationID="GetEndpoints" method="get" path="/v1/projects/{projectID}/endpoints" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="CreateEndpoint" method="post" path="/v1/projects/{projectID}/endpoints" -->
```go
package main
