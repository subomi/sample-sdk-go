...
// Generated from OpenAPI doc version 24.1.4 and generator version 2.863.1
...
func New(opts ...SDKOption) *Convoy {
	sdk := &Convoy{
		SDKVersion: "0.3.0-rc.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.3.0-rc.3 2.863.1 24.1.4 github.com/frain-dev/convoy",
