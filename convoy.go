...
// Generated from OpenAPI doc version 24.1.4 and generator version 2.767.2
...
func New(opts ...SDKOption) *Convoy {
	sdk := &Convoy{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.3.0-rc.1 2.767.2 24.1.4 github.com/frain-dev/convoy",
